...
class Crawler(HttpCaseWithUserDemo):
    """ Test suite crawling an 4levels CMS instance and checking that all
    ...
    def setUp(self):
        ...
        self.env.ref('website.default_website').write({
            'social_facebook': "https://www.facebook.com/4levels",
            'social_twitter': 'https://twitter.com/4levels',
