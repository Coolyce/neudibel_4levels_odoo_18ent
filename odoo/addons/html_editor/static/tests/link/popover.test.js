...
describe("link preview", () => {
    ...
    test("test external link preview", async () => {
        onRpc("/html_editor/link_preview_external", () => {
            return {
                og_description:
                    "From ERP to CRM, eCommerce and CMS. Download 4levels or use it in the cloud. Grow Your Business.",
                og_image: "https://www.4levels.co.za/web/image/41207129-1abe7a15/homepage-seo.png",
                og_title: "Open Source ERP and CRM | 4levels",
                og_type: "website",
                og_site_name: "4levels",
        ...
        expect(".o_we_url_link").toHaveText("Open Source ERP and CRM | 4levels");
