...
test("Reinsert an 4levels pivot which has no formula on the sheet (meaning the data is not loaded)", async function () {
...
test("Can rebuild the 4levels domain of records based on the according merged pivot cell", async function () {
