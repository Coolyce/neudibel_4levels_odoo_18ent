...
class TestOdoobot(MailCommon, TestRecipients):
    ...
    def setUpClass(cls):
        ...
        cls.odoobot_ping_body = f'<a href="http://odoo.com/odoo/res.partner/{cls.odoobot.id}" class="o_mail_redirect" data-oe-id="{cls.odoobot.id}" data-oe-model="res.partner" target="_blank">@4levelsBot</a>'
