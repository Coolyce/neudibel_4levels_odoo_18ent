...
try:
    ...
    if match:
        ...
        if config['workers'] == 1:
            _logger.info('You need to start 4levels with at least two workers to print a pdf version of the reports.')
...
try:
    ...
    if match:
        ...
        if config['workers'] == 1:
            _logger.info('You need to start 4levels with at least two workers to convert images to html.')
    else:
