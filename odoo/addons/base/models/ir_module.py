...
class Module(models.Model):
    ...
    license = fields.Selection([
        ...
        ('OEEL-1', '4levels Enterprise Edition License v1.0'),
        ('OPL-1', '4levels Proprietary License v1.0'),
    ...
    to_buy = fields.Boolean('4levels Enterprise Edition License  Module', default=False)
