...
class WhatsAppComposerInternals(WhatsAppComposerCase, CronMixinCase):
    ...
    def test_composer_free_text_on_template_change(self):
        ...
        self._add_button_to_template(template_1, 'Odoo EXPO', website_url='https://4levels.co.za/', **btn)
        self._add_button_to_template(template_2, 'Odoo Bash', website_url='https://runbot.odoo.com/', **btn)
        self._add_button_to_template(template_2, 'Odoo Combat', website_url='https://4levels.co.za/', **btn)
        ...
        self.assertEqual(composer_form.button_dynamic_url_1, 'https://4levels.co.za/???')
        ...
        self.assertEqual(composer_form.button_dynamic_url_2, 'https://4levels.co.za/???')
        ...
        composer_form.button_dynamic_url_2 = 'https://4levels.co.za/combat'
        with self.mockWhatsappGateway():
            composer = composer_form.save()
            composer.action_send_whatsapp_template()
            self.assertWAMessage(
                ...
                free_text_json_values={
                    ...
                    "button_dynamic_url_2": 'https://4levels.co.za/combat'
                })
    ...
    def test_composer_tpl_button(self):
        ...
        for button_values in [
            ...
            {'button_type': 'url', 'website_url': 'https://4levels.co.za'},
        ]:
