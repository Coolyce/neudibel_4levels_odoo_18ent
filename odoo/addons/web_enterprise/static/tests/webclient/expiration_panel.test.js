...
test("Expiration Panel one app installed, buy subscription", async () => {
    ...
    expect(browser.location.href).toBe("https://www.4levels.co.za/odoo-enterprise/upgrade?num_users=7");
});
...
test("One app installed, upgrade database", async () => {
    ...
    expect(browser.location.href).toBe(
        "https://www.4levels.co.za/odoo-enterprise/upsell?num_users=13&contract=ABC"
    );
});
...
test("One app installed, navigation to renewal page", async () => {
    ...
    expect(browser.location.href).toBe("https://www.4levels.co.za/odoo-enterprise/renew?contract=ABC");
