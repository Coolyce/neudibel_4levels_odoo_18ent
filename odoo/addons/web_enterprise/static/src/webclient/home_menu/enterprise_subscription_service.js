...
//        }
    ...
    async buy() {
        ...
        browser.location = `https://www.4levels.co.za/odoo-enterprise/upgrade?num_users=${nbUsers}`;
    }
    /**
...
//    }
    ...
    async renew() {
        ...
        const url = "https://www.4levels.co.za/odoo-enterprise/renew";
    ...
    async upsell() {
        ...
        const url = "https://www.4levels.co.za/odoo-enterprise/upsell";
        const contractQueryString = enterpriseCode ? `&contract=${enterpriseCode}` : "";
