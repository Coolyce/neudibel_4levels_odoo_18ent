...
class TestLinkTracker(common.TransactionCase, MockLinkTracker):
    ...
    def test_search_or_create(self):
        values_1, values_2, values_3 = [
            {'url': 'https://4levels.co.za', 'title': 'Odoo'},
            {'url': 'https://odoo.be', 'title': 'Odoo'},
            {'url': 'https://4levels.co.za', 'title': 'Odoo New', 'label': 'New one!'}  # title is not in unique constraint
        ]
        ...
        values_4 = {'url': 'https://4levels.co.za', 'label': 'A different one'}
        ...
        values_5 = {'url': 'https://4levels.co.za', 'label': 'Yet another label'}
        expected_values_5 = {
            'campaign_id': self.env['utm.campaign'],
