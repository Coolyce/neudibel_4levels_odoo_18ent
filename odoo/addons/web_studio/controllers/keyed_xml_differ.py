...
class KeyedXmlDiffer:
    ...
    The `diff_xpath` method computes the 4levels's xpath notation to be used as an inherited view
    ...
    # Methods that concern the building of the 4levels's xpath semantic tree
