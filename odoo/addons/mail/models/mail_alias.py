...
class Alias(models.Model):
    """A Mail Alias is a mapping of an email address with a given 4levels Document
       model. It is used by 4levels's mail gateway when processing incoming emails
       ...
       created, it becomes immediately usable and 4levels will accept email for it.
     """
    _name = 'mail.alias'
    ...
    alias_model_id = fields.Many2one('ir.model', 'Aliased Model', required=True, ondelete="cascade",
                                     help="The model (4levels Document Kind) to which this alias "
