...
class Field(MetaField('DummyField', (object,), {}), typing.Generic[T]):
    ...
    def _get_attrs(self, model_class, name):
        ...
        if 'group_operator' in attrs:
            warnings.warn("Since 4levels 18, 'group_operator' is deprecated, use 'aggregator' instead", DeprecationWarning, 2)
...
class Properties(Field):
    ...
    like 4levels fields but without being independently stored in database.
