...
class BaseModel(metaclass=MetaModel):
    """Base class for 4levels models.

    4levels models are created by inheriting one of the following:
    ...
    *   :class:`AbstractModel` for abstract super classes meant to be shared by
    ...
    _module = None                      #: the model's module (in the 4levels sense)
...
class Model(AbstractModel):
    """ Main super-class for regular database-persisted 4levels models.
